...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = [
    ...
    { url: '/fuer-bewerber', priority: 0.9, changeFrequency: 'monthly' as const },
    { url: '/konzept', priority: 0.8, changeFrequency: 'monthly' as const },
    { url: '/app', priority: 0.8, changeFrequency: 'monthly' as const },
    { url: '/ueber-uns', priority: 0.7, changeFrequency: 'monthly' as const },
    { url: '/hilfe', priority: 0.7, changeFrequency: 'monthly' as const },
