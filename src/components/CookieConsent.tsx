...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] p-4">
      <div className="mx-auto max-w-2xl rounded-2xl border border-gray-700 bg-gray-900/95 backdrop-blur-sm p-5 shadow-2xl">
        <div className="mb-3">
          <h3 className="text-sm font-semibold text-white">Cookie-Einstellungen</h3>
          <p className="mt-1 text-xs text-gray-400 leading-relaxed">
            Wir verwenden Cookies, um Ihnen die bestmögliche Erfahrung zu bieten.
            Notwendige Cookies sind für die Funktion der Website erforderlich.{' '}
            <a href="/datenschutz" className="text-violet-400 hover:underline">
        ...
        {showDetails && (
          <div className="mb-4 space-y-2 rounded-lg bg-gray-800/50 p-3">
            <label className="flex items-center gap-3 text-xs text-gray-300">
              <input type="checkbox" checked disabled className="rounded accent-violet-500" />
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="rounded-lg border border-gray-600 px-4 py-2 text-xs font-medium text-gray-300 hover:bg-gray-800 transition"
          >
            Nur notwendige
          </button>
          {showDetails ? (
            <button
              ...
              className="rounded-lg bg-violet-600 px-4 py-2 text-xs font-medium text-white hover:bg-violet-500 transition"
            >
              Auswahl speichern
            </button>
          ) : (
